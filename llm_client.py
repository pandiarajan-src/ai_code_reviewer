...
class LLMClient:
    ...
    async def get_code_review(self, diff_content: str) -> Optional[str]:
    ...
    async def _get_openai_review(self, prompt: str) -> Optional[str]:
    ...
    async def _get_ollama_review(self, prompt: str) -> Optional[str]:
    ...
    async def get_summary_review(self, diff_content: str, file_count: int) -> Optional[str]:
